...
var _propTypes3 = _interopRequireDefault(_propTypes)
...
var MarkerWithLabel = (exports.MarkerWithLabel = (function(
  ...
  function MarkerWithLabel(props, context) {
    ...
    var markerClusterer = _this.context[_constants2.MARKER_CLUSTERER]
    if (markerClusterer) {
      markerClusterer.addMarker(markerWithLabel, !!_this.props.noRedraw)
    } else {
      markerWithLabel.setMap(_this.context[_constants2.MAP])
    }
    _this.state = (0, _defineProperty3.default)(
      {},
      _constants2.MARKER_WITH_LABEL,
      markerWithLabel
    )
    return _this
  }
  ...
  ;(0, _createClass3.default)(MarkerWithLabel, [
    {
      ...
      value: function componentDidMount() {
        ;(0, _MapChildHelper.componentDidMount)(
          this,
          this.state[_constants2.MARKER_WITH_LABEL],
          eventMap
        )
        ...
        this.state[_constants2.MARKER_WITH_LABEL].set("labelContent", container)
      },
    },
    {
      ...
      value: function componentDidUpdate(prevProps) {
        ...
        if (this.props.children !== prevProps.children) {
          _reactDom2.default.unstable_renderSubtreeIntoContainer(
            this,
            _react2.default.Children.only(this.props.children),
            this.state[_constants2.MARKER_WITH_LABEL].get("labelContent")
          )
        }
      },
    },
    {
      ...
      value: function componentWillUnmount() {
        ...
        var markerWithLabel = this.state[_constants2.MARKER_WITH_LABEL]
        if (markerWithLabel) {
          var markerClusterer = this.context[_constants2.MARKER_CLUSTERER]
          if (markerClusterer) {
...
MarkerWithLabel.propTypes = {
   ...
   * @see https://cdn.rawgit.com/googlemaps/v3-utility-library/master/markerwithlabel/src/markerwithlabel.js
   */
  labelAnchor: _propTypes3.default.object,

  /**
   * For `MarkerWithLabel`
   * @see https://cdn.rawgit.com/googlemaps/v3-utility-library/master/markerwithlabel/src/markerwithlabel.js
   */
  labelClass: _propTypes3.default.string,
   ...
   * @see https://cdn.rawgit.com/googlemaps/v3-utility-library/master/markerwithlabel/src/markerwithlabel.js
   */
  labelStyle: _propTypes3.default.object,

  /**
   * For `MarkerWithLabel`
   * @see https://cdn.rawgit.com/googlemaps/v3-utility-library/master/markerwithlabel/src/markerwithlabel.js
   */
  labelVisible: _propTypes3.default.bool,

  /**
   * For the 2nd argument of `MarkerCluster#addMarker`
   * @see https://github.com/mikesaidani/marker-clusterer-plus
   */
  noRedraw: _propTypes3.default.bool,
   ...
   * function
   */
  onDblClick: _propTypes3.default.func,

  /**
   * function
   */
  onDragEnd: _propTypes3.default.func,

  /**
   * function
   */
  onDragStart: _propTypes3.default.func,
   ...
   * function
   */
  onMouseOut: _propTypes3.default.func,

  /**
   * function
   */
  onMouseOver: _propTypes3.default.func,
   ...
   * function
   */
  onRightClick: _propTypes3.default.func,
}
...
(0, _defineProperty3.default)(
  _MarkerWithLabel$cont,
  _constants2.MAP,
  _propTypes3.default.object
),
(0, _defineProperty3.default)(
  _MarkerWithLabel$cont,
  _constants2.MARKER_CLUSTERER,
  _propTypes3.default.object
),
_MarkerWithLabel$cont)
...
(0, _defineProperty3.default)(_eventMap, "onDblClick", "dblclick"),
(0, _defineProperty3.default)(_eventMap, "onDragEnd", "dragend"),
(0, _defineProperty3.default)(_eventMap, "onDragStart", "dragstart"),
(0, _defineProperty3.default)(_eventMap, "onMouseDown", "mousedown"),
(0, _defineProperty3.default)(_eventMap, "onMouseOut", "mouseout"),
(0, _defineProperty3.default)(_eventMap, "onMouseOver", "mouseover"),
(0, _defineProperty3.default)(_eventMap, "onMouseUp", "mouseup"),
(0, _defineProperty3.default)(_eventMap, "onRightClick", "rightclick"),
_eventMap)
