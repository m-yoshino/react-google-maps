...
var InfoWindow = (exports.InfoWindow = (function(_React$PureComponent) {
  ...
  function InfoWindow(props, context) {
    ...
    infoWindow.setMap(_this.context[_constants2.MAP])
    _this.state = (0, _defineProperty3.default)(
      {},
      _constants2.INFO_WINDOW,
      infoWindow
    )
    return _this
  }
  ...
  ;(0, _createClass3.default)(InfoWindow, [
    ...
    },
    {
      ...
      value: function componentDidMount() {
        ;(0, _MapChildHelper.componentDidMount)(
          this,
          this.state[_constants2.INFO_WINDOW],
          eventMap
        )
        if (_react2.default.version.match(/^16/)) {
          this.state[_constants2.INFO_WINDOW].setContent(this.containerElement)
          open(
            this.state[_constants2.INFO_WINDOW],
            this.context[_constants2.ANCHOR]
          )
          return
        }
        ...
        this.state[_constants2.INFO_WINDOW].setContent(content)
        open(
          this.state[_constants2.INFO_WINDOW],
          this.context[_constants2.ANCHOR]
        )
      ...
      value: function componentDidUpdate(prevProps) {
        ...
        if (this.props.children !== prevProps.children) {
          _reactDom2.default.unstable_renderSubtreeIntoContainer(
            this,
            _react2.default.Children.only(this.props.children),
            this.state[_constants2.INFO_WINDOW].getContent()
          )
        }
      },
    },
    {
      ...
      value: function componentWillUnmount() {
        ...
        var infoWindow = this.state[_constants2.INFO_WINDOW]
        if (infoWindow) {
          if (
...
InfoWindow.propTypes = {
   ...
   * function
   */
  onCloseClick: _propTypes3.default.func,

  /**
   * function
   */
  onDomReady: _propTypes3.default.func,
}
...
(0, _defineProperty3.default)(_eventMap, "onCloseClick", "closeclick"),
(0, _defineProperty3.default)(_eventMap, "onDomReady", "domready"),
_eventMap)
