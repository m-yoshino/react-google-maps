...
var DirectionsRenderer = (exports.DirectionsRenderer = (function(
  ...
  function DirectionsRenderer(props, context) {
    ...
    directionsRenderer.setMap(_this.context[_constants2.MAP])
    _this.state = (0, _defineProperty3.default)(
      {},
      _constants2.DIRECTIONS_RENDERER,
      directionsRenderer
    )
    return _this
  }
  ...
  ;(0, _createClass3.default)(DirectionsRenderer, [
    {
      ...
      value: function componentDidMount() {
        ;(0, _MapChildHelper.componentDidMount)(
          this,
          this.state[_constants2.DIRECTIONS_RENDERER],
          eventMap
        )
      },
    },
    ...
    },
    {
      ...
      value: function componentWillUnmount() {
        ...
        var directionsRenderer = this.state[_constants2.DIRECTIONS_RENDERER]
