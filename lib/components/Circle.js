...
var Circle = (exports.Circle = (function(_React$PureComponent) {
  ...
  function Circle(props, context) {
    ...
    circle.setMap(_this.context[_constants2.MAP])
    _this.state = (0, _defineProperty3.default)({}, _constants2.CIRCLE, circle)
    return _this
  }
  ...
  ;(0, _createClass3.default)(Circle, [
    ...
    },
    {
      ...
      value: function componentWillUnmount() {
        ...
        var circle = this.state[_constants2.CIRCLE]
        if (circle) {
          circle.setMap(null)
        }
      },
...
Circle.propTypes = {
   ...
   * function
   */
  onMouseMove: _propTypes3.default.func,
...
(0, _defineProperty3.default)(_eventMap, "onMouseMove", "mousemove"),
