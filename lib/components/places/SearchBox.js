  ...
  ;(0, _createClass3.default)(SearchBox, [
    ...
    },
    {
      ...
      value: function componentDidMount() {
        var searchBox = this.state[_constants2.SEARCH_BOX]
        if (_react2.default.version.match(/^16/)) {
    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps) {
        ;(0, _MapChildHelper.componentDidUpdate)(
          this,
          this.state[_constants2.SEARCH_BOX],
          eventMap,
          updaterMap,
          prevProps
        )
    ...
    },
    {
       ...
       */
        ...
        this.setState(
          (0, _defineProperty3.default)({}, _constants2.SEARCH_BOX, searchBox)
        )
        return searchBox
      },
    },
      ...
      value: function handleMountAtControlPosition() {
        if (isValidControlPosition(this.props.controlPosition)) {
          this.mountControlIndex =
            -1 +
            this.context[_constants2.MAP].controls[
    ...
    },
    {
      ...
      value: function handleUnmountAtControlPosition() {
        if (isValidControlPosition(this.props.controlPosition)) {
          var child = this.context[_constants2.MAP].controls[
            this.props.controlPosition
...
SearchBox.propTypes = {
   ...
   * @type number
   */
  controlPosition: _propTypes3.default.number,
