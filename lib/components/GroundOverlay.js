...
var GroundOverlay = (exports.GroundOverlay = (function(_React$PureComponent) {
  ...
  function GroundOverlay(props, context) {
    ...
    groundOverlay.setMap(_this.context[_constants2.MAP])
    _this.state = (0, _defineProperty3.default)(
      {},
      _constants2.GROUND_LAYER,
      groundOverlay
    )
    return _this
  }
  ...
  ;(0, _createClass3.default)(GroundOverlay, [
    {
      ...
      value: function componentDidMount() {
        ;(0, _MapChildHelper.componentDidMount)(
          this,
          this.state[_constants2.GROUND_LAYER],
          eventMap
        )
      },
    },
    ...
    },
    {
      ...
      value: function componentWillUnmount() {
        ...
        var GroundOverlay = this.state[_constants2.GROUND_LAYER]
        if (GroundOverlay) {
...
GroundOverlay.propTypes = {
   ...
   * @type string
   */
  defaultUrl: _propTypes3.default.string /* v10.0.0 .isRequired */ /**
   * @see https://developers.google.com/maps/documentation/javascript/reference#GroundOverlay
   */,

  defaultBounds: _propTypes3.default.object /* v10.0.0 .isRequired */ /**
   * @type string
   * @deprecated use `defaultUrl` instead. It will be removed in v10.0.0
   */,

  url: _propTypes3.default.string,

  /**
   * @see https://developers.google.com/maps/documentation/javascript/reference#GroundOverlay
   * @deprecated use `defaultBounds` instead. It will be removed in v10.0.0
   */
  bounds: _propTypes3.default.object,
...
var eventMap = (0, _defineProperty3.default)(
  {
    onDblClick: "dblclick",
    onClick: "click",
  },
