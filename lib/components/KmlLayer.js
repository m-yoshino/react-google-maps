...
var KmlLayer = (exports.KmlLayer = (function(_React$PureComponent) {
  ...
  function KmlLayer(props, context) {
    ...
    kmlLayer.setMap(_this.context[_constants2.MAP])
    _this.state = (0, _defineProperty3.default)(
      {},
      _constants2.KML_LAYER,
      kmlLayer
    )
    return _this
  }
  ...
  ;(0, _createClass3.default)(KmlLayer, [
    {
      ...
      value: function componentDidMount() {
        ;(0, _MapChildHelper.componentDidMount)(
          this,
          this.state[_constants2.KML_LAYER],
          eventMap
        )
      },
    },
    ...
    },
    {
      ...
      value: function componentWillUnmount() {
        ...
        var kmlLayer = this.state[_constants2.KML_LAYER]
        if (kmlLayer) {
...
KmlLayer.propTypes = {
   ...
   * function
   */
  onDefaultViewportChanged: _propTypes3.default.func,
}
