...
var HeatmapLayer = (exports.HeatmapLayer = (function(_React$PureComponent) {
  ...
  function HeatmapLayer(props, context) {
    ...
    heatmapLayer.setMap(_this.context[_constants2.MAP])
    _this.state = (0, _defineProperty3.default)(
      {},
      _constants2.HEATMAP_LAYER,
      heatmapLayer
    )
    return _this
  }
  ...
  ;(0, _createClass3.default)(HeatmapLayer, [
    {
      ...
      value: function componentDidMount() {
        ;(0, _MapChildHelper.componentDidMount)(
          this,
          this.state[_constants2.HEATMAP_LAYER],
          eventMap
        )
      },
    },
    ...
    },
    {
      ...
      value: function componentWillUnmount() {
        ...
        var heatmapLayer = this.state[_constants2.HEATMAP_LAYER]
        if (heatmapLayer) {
