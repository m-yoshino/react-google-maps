...
var DrawingManager = (exports.DrawingManager = (function(_React$PureComponent) {
  ...
  function DrawingManager(props, context) {
    ...
    drawingManager.setMap(_this.context[_constants2.MAP])
    _this.state = (0, _defineProperty3.default)(
      {},
      _constants2.DRAWING_MANAGER,
      drawingManager
    )
    return _this
  }
  ...
  ;(0, _createClass3.default)(DrawingManager, [
    {
      ...
      value: function componentDidMount() {
        ;(0, _MapChildHelper.componentDidMount)(
          this,
          this.state[_constants2.DRAWING_MANAGER],
          eventMap
        )
      },
    },
    ...
    },
    {
      ...
      value: function componentWillUnmount() {
        ...
        var drawingManager = this.state[_constants2.DRAWING_MANAGER]
        if (drawingManager) {
...
DrawingManager.propTypes = {
   ...
   * function
   */
  onCircleComplete: _propTypes3.default.func,

  /**
   * function
   */
  onMarkerComplete: _propTypes3.default.func,

  /**
   * function
   */
  onOverlayComplete: _propTypes3.default.func,

  /**
   * function
   */
  onPolygonComplete: _propTypes3.default.func,

  /**
   * function
   */
  onPolylineComplete: _propTypes3.default.func,

  /**
   * function
   */
  onRectangleComplete: _propTypes3.default.func,
}
...
(0, _defineProperty3.default)(_eventMap, "onCircleComplete", "circlecomplete"),
(0, _defineProperty3.default)(_eventMap, "onMarkerComplete", "markercomplete"),
