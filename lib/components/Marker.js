...
var Marker = (exports.Marker = (function(_React$PureComponent) {
  ...
  function Marker(props, context) {
    ...
    if (markerClusterer) {
      ...
      marker.setMap(_this.context[_constants2.MAP])
    }
    _this.state = (0, _defineProperty3.default)({}, _constants2.MARKER, marker)
    return _this
  }
  ...
  ;(0, _createClass3.default)(Marker, [
    {
      ...
      value: function getChildContext() {
        return (0, _defineProperty3.default)(
          {},
          _constants2.ANCHOR,
          this.context[_constants2.ANCHOR] || this.state[_constants2.MARKER]
        )
      },
    },
    {
    ...
    },
    {
      ...
      value: function componentWillUnmount() {
        ...
        var marker = this.state[_constants2.MARKER]
        if (marker) {
